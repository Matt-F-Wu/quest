...
export default class extends Component {
  ...
  static propTypes = {
    ...
    selectedNextButton: PropTypes.element,
    prevButton: PropTypes.element,
    selectedPrevButton: PropTypes.element,
    homeButton: PropTypes.element,
    selectedHomeButton: PropTypes.element,
    /**
  ...
  renderNextButton = () => {
    ...
    if (this.state.index == 2) {
      button = this.props.selectedNextButton
    } else {
      button = this.props.nextButton
    }
    // Current button always takes you to index +1
    let newIndex = 2   
    if (this.state.index == 1) newIndex = 1
  ...
  renderPrevButton = () => {
    ...
    if (this.state.index == 0) {
      button = this.props.selectedPrevButton
    } else {
      button = this.props.prevButton
    }
    let newIndex = -1 - (this.state.index - 1)    // Previous button always takes you to index -1
  ...
  renderHomeButton = () => {
    ...
    return (
      <TouchableOpacity style={{bottom:bottomMargin}}
  ...
  renderButtons = () => {
    ...
    if (this.state.index == 1) {
      wrapperStyle = styles.homeButtonsStyle
    } else {
      wrapperStyle = styles.sidePagesButtonStyle
    }
