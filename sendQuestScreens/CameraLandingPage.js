...
export default class CameraLandingPage extends CameraBase {
    ...
    makeChildren(){
      ...
      return [
          ...
          <View key={'treasure_map'} style={{position: 'absolute', left: '5%', width: '90%', height: '30%', alignSelf:'center'}}><WebView scrollEnabled={false} style={{width: '100%', height: '100%', backgroundColor: 'transparent'}} source={require('../assets/webviews/wavy_map.html')} /></View>, 
